...
//--------------------------------------------------------------
void testApp::drawAxis(string marker, int height, int x, int y) {
	int shift = 0;
	if (height == 15) {
		ofSetColor(255, 255, 255);
		shift = 3;
...
//--------------------------------------------------------------
void testApp::drawNavigationItem(int x, int y, string name, bool selected) {
	ofSetColor(0, 0, 0);
...
void testApp::setSelectedParamsAndPatterns() {
...
//--------------------------------------------------------------
void testApp::setGainSliderValue() {
...
//--------------------------------------------------------------
void testApp::setScaleSliderValue() {
...
//--------------------------------------------------------------
void testApp::resetSelectValues() {
	selectedBeat = 0;
	selectedStep = 0;
...
//--------------------------------------------------------------
bool testApp::mouseInside (int x, int y, int width, int height) {
